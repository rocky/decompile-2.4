...
/* Interface for marshal.c - this is marshal.h directly included here */
...
//
// end stuff copied from pystrtod.c
//
...
initmarshal_24(void)
{
	PyObject *mod = Py_InitModule("marshal_24", marshal_methods);
